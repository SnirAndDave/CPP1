...
bool TopLeftRecursiveSolver::can_be_placed(const int r, const int c, const vector<vector<Element>>& mat,
...
bool TopLeftRecursiveSolver::halt_condition(const int r, const int, pair<int, int> dimensions) const
{
	return r == dimensions.first;
}

pair<int, int> TopLeftRecursiveSolver::get_next_indices(const int r, const int c, const pair<int, int> dimensions) const
{
